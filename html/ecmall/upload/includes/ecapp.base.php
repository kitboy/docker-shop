...
EOT;
    ...
    function t_mailto($to, $subject, $message){
         import('mailer.lib');
        $model_setting = &af('settings');
        $setting = $model_setting->getAll(); //载入系统设置数据
       $mailer = new Mailer($setting['from'] , $email_addr, $email_type, $email_host, $email_port, $email_id, $email_pass);
        $mail_result = $mailer->send($to, $subject, $message, CHARSET, 1);
    }
