 ...
 * ============================================================================
 * °æÈ¨ËùÓĞ (C) 2005-2007 ¿µÊ¢´´Ïë£¨±±¾©£©¿Æ¼¼ÓĞÏŞ¹«Ë¾£¬²¢±£ÁôËùÓĞÈ¨Àû¡£
 * ÍøÕ¾µØÖ·: http://www.ecshop.com
 * ----------------------------------------------------------------------------
 * ÕâÊÇÒ»¸öÃâ·Ñ¿ªÔ´µÄÈí¼ş£»ÕâÒâÎ¶×ÅÄú¿ÉÒÔÔÚ²»ÓÃÓÚÉÌÒµÄ¿µÄµÄÇ°ÌáÏÂ¶Ô³ÌĞò´úÂë
 * ½øĞĞĞŞ¸Ä¡¢Ê¹ÓÃºÍÔÙ·¢²¼¡£
 * ============================================================================
 * $Author: dolphin $
...
$_LANG['readme_title']                =  'ECSHOPÉı¼¶³ÌĞò µÚ1²½/¹²2²½ ËµÃ÷Ò³';
$_LANG['checking_title']                =  'ECShopÉı¼¶³ÌĞò µÚ2²½/¹²2²½ »·¾³¼ì²â';
$_LANG['check_system_environment']          = '¼ì²âÏµÍ³»·¾³';

$_LANG['copyright']                     = '&copy; 2005-2007 <a href="http://www.ecshop.com" target="_blank">¿µÊ¢´´Ïë£¨±±¾©£©¿Æ¼¼ÓĞÏŞ¹«Ë¾</a>¡£±£ÁôËùÓĞÈ¨Àû¡£';
...
$_LANG['readme_charset']  = '<span style="color:red"><strong>ÖØÒª£º</strong>MySQLµÄ±àÂë±ØĞëÓëECShopµÄ±àÂëÒ»ÖÂ¡£Èç¹ûÁ½ÕßÓĞ²»Ò»ÖÂĞÔ£¬ÒÔÄúÑ¡ÔñµÄÎª×¼£¡</span>';
$_LANG['mysql_charset']  = 'MySQLÊı¾İ¿âµÄ±àÂë£º';
...
$_LANG['opt_charset']  = '<select name="select_charset" id="select_charset">
    <option value="">ÇëÑ¡Ôñ±àÂëÀàĞÍ</option>
